...
data = pd.read_excel("E:/Data Science/Movie Recommendation System/Movie Recommendation System/movie data_new.xlsx")
data.info()
data.rename(columns={'Unname: 0':'movie_id'}, inplace=True)
